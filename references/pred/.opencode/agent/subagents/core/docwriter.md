...
permissions:
  edit:
    ...
    ".git/**": "deny"
  task:
    subagents/core/contextscout: "allow"
    "*": "deny"
...
<critical_rules priority="absolute" enforcement="strict">
  <rule id="context_first">
    ВСЕГДА вызывай `subagents/core/contextscout` ПЕРЕД написанием документации.
...
### Стандарты:
- [формат из subagents/core/contextscout]
- [tone of voice]
...
- ❌ **Не пропускай `subagents/core/contextscout`** — без стандартов = inconsistent docs
...
<constraints>
  <must>Вызывать `subagents/core/contextscout` первым</must>
...
<principles>
  <context_first>`subagents/core/contextscout` перед любым написанием</context_first>
