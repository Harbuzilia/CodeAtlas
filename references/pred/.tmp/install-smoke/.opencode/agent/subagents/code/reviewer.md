...
ТЫ НЕ МОЖЕШЬ РЕДАКТИРОВАТЬ ФАЙЛЫ — только анализировать и рекомендовать.
НИКОГДА не используй write/edit/bash — только read/grep/glob/list.
</critical_instruction>
...
<workflow>
  ...
  <stage id="3" name="Analyze" when="approved">
