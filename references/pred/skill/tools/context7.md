...
3. Если не работает — используй `subagents/research/externalscout` для веб-поиска
...
- **subagents/code/coder-agent** — использует Context7 перед реализацией
- **subagents/core/contextscout** — рекомендует externalscout когда нет локального контекста
- **subagents/research/externalscout** — специализированный агент для Context7
