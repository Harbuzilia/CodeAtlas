<p align="center">
  <img src="https://img.shields.io/badge/OpenCode-Agentic_Engine-black?style=for-the-badge&logo=openai" alt="OpenCode Logo"/>
</p>
...
OpenCode-Lite is the public open-core version of the powerful **OpenCode** agentic ecosystem. It is an advanced autonomous multi-agent orchestration engine designed to turn large language models into highly capable, autonomous software engineering teams. 

Unlike basic agent wrappers, OpenCode implements a strictly enforced **deterministic delegation workflow**: agents don't just chat; they analyze, plan, route, execute, and validate in a structured pipeline.

---

## 🔥 The "Wow" Factor: Why OpenCode?
...
- **⚡ AST-Driven Code Perception:** Not just grep. Powered by `ast-index` and `repomap`, OpenCode truly understands your codebase topology, class hierarchies, and call graphs.
...
- `opencode.json`: The core routing and configuration manifest.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/YourUsername/OpenCode-Lite.git
   cd OpenCode-Lite
   ```
...
3. Configure your API key. Edit `.opencode/opencode.json` (or place in `~/.config/opencode/opencode.json`) to add your model endpoints and OpenRouter API key.
...
## 💳 OpenCode-Lite vs. OpenCode Pro

This repository houses the **OpenCode-Lite** engine. It is a fully functional slice of the architecture providing immense value for single developers and open-source experiments.

For enterprise teams, complex monorepos, and mission-critical systems, **OpenCode Pro** includes the following extended capabilities:
...
### Contact ✉️
Interested in **OpenCode Pro**, dedicated support, or deploying this architecture internally at your company?
